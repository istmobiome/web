---
title: Assembley-based Metagenomic Workflow
linktitle: Workflow
summary:
...
<details markdown="1"><summary>Show/hide VIRSORTER job script</summary>
<pre><code>
# /bin/sh
# ----------------Parameters---------------------- #
#$ -S /bin/sh
...
<details markdown="1"><summary>Show/hide KAIJU job script</summary>
<pre><code>
# /bin/sh
# ----------------Parameters---------------------- #
#$ -S /bin/sh
...
<details markdown="1"><summary>Show/hide KAIJU import and summarize job script</summary>
<pre><code>
# /bin/sh
# ----------------Parameters---------------------- #
#$ -S /bin/sh
...
<details markdown="1"><summary>Show/hide Kraken classification job details</summary>
<pre><code>
# /bin/sh
# ----------------Parameters---------------------- #
#$ -S /bin/sh
...
<details markdown="1"><summary>Show/hide Import Kraken taxonomy job details</summary>
<pre><code>
# /bin/sh
# ----------------Parameters---------------------- #
#$ -S /bin/sh
...
<details markdown="1"><summary>Show/hide SCG and Pfam job details</summary>
<pre><code>
# /bin/sh
# ----------------Parameters---------------------- #
#$ -S /bin/sh
...
<details markdown="1"><summary>Show/hide  Merge Profile.db job details</summary>
<pre><code>
# /bin/sh
# ----------------Parameters---------------------- #
#$ -S /bin/sh
...
<details markdown="1"><summary>Show/hide Virsorter annotation import job details</summary>
<pre><code>
# /bin/sh
# ----------------Parameters---------------------- #
#$ -S /bin/sh
