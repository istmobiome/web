...
We will use many other external tools to generate data products that we can port into the anvi'o ecosystem.
...
Now we are ready to install anvi'o. You can find up-to-date installation [instructions](http://merenlab.org/2016/06/26/installation-v2/) on the anvi'o website. For posterity I will describe here exactly how I set everything up at the time of analysis.
